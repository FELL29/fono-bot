...
export const ChildCard = memo(({ child, progress = 0, onEdit, onDelete, onClick }: ChildCardProps) => {
  ...
  return (
    <Card 
      className="cursor-pointer transition-all duration-200 hover:shadow-lg hover:scale-[1.02] border-l-4 border-l-primary/20 hover:border-l-primary relative group"
